...
const NotificationActionButton: React.FC<NotificationActionButtonProps> = ({
  ...
  const renderIcon = () => {
    ...
    switch (metadata.action_type) {
      case 'openUrl':
        return <ExternalLink className="jd-h-3.5 jd-w-3.5 jd-mr-1" />;
      case 'showSettings':
        return <svg className="jd-h-3.5 jd-w-3.5 jd-mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
